...
class Emitter():
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        # elif type(in_) is cgen.ClassType or type(in_) is ArrayType or type(in_) is StringType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame): # for var normal 
        #name: String
        #inType: Type
        #index: Int
        #frame: Frame
    ...
    *
    '''
    def emitREADVAR2(self, name, typ, frame): # for array cell of array type k can xu li!!!
        #name: String
        #typ: Type
        #frame: Frame
        #... -> ..., value
    ...
    *
    '''
    def emitWRITEVAR2(self, name, typ, frame): #for array Cell khong can xu ly!!!
        #name: String
        #typ: Type
        #frame: Frame
        #..., value -> ...
    ...
    *   @param in the type of the operands.
    ...
    def emitNOT(self, in_, frame):
        ...
        result.append(self.emitGOTO(label2, frame)) # note!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    *   generate ior
    ...
    def emitREOP(self, op, in_, frame):
        ...
        result = list()
        labelF = frame.getNewLabel() #Note.............................................................
        labelO = frame.getNewLabel() #Note.............................................................
        ...
        frame.pop()
        result.append(self.emitGOTO(labelO, frame)) #Note...............................
    ...
    def emitRELOP(self, op, in_, trueLabel, falseLabel, frame):
        ...
        result.append(self.jvm.emitGOTO(trueLabel)) #note.....................................................
        return ''.join(result)
    ...
    *   @param in the type of the returned expression.
    ...
    def emitRETURN(self, in_, frame):
        ...
        elif type(in_) is StringType:   #or type(in_) is ArrayType: khong can xu li Array!!!
            frame.pop()

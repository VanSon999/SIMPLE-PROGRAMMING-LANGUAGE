...
class MPVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MPParser#sub1.
    def visitSub1(self, ctx:MPParser.Sub1Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MPParser#sub2.
    def visitSub2(self, ctx:MPParser.Sub2Context):
        return self.visitChildren(ctx)

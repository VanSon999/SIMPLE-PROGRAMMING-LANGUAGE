...
//////////////////////////////////////////////Parser/////////////////////////////////////////////
program : (var_decl_total | func_decl_total | proc_decl_total)+ EOF;
...
func_decl_total: FUNCTION IDENTIFIER LB (parameter (SEMI parameter)*)? RB COLON (type_data | type_array) SEMI (var_decl_total)? compound_statement;
parameter: list_id COLON (type_data | type_array);

//2.3: Procedure declaration:
proc_decl_total: PROCEDURE IDENTIFIER LB (parameter (SEMI parameter)*)? RB SEMI (var_decl_total)? compound_statement;
...
REAL_TYPE:('-')? ((INTLIT '.' INTLIT? | '.' INTLIT ) ExponentPart? | INTLIT ExponentPart);

...
class ASTGeneration(MPVisitor):
    ...
    def visitType_array(self,ctx:MPParser.Type_arrayContext):
        int1 = int('-' + ctx.INTEGER_TYPE(0).getText()) if ctx.SUB(0) != None else int(ctx.INTEGER_TYPE(0).getText())
        int2 = int('-' + ctx.INTEGER_TYPE(1).getText()) if ctx.SUB(1) != None else int(ctx.INTEGER_TYPE(1).getText())
